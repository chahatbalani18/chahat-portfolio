          ...
          <div className="about-column">
            <article className="about-text-card" data-reveal>
              ...
              <div className="about-highlight">
                ...
                <div className="about-highlight-text">
                  Take messy data → ask the right questions → build a clean model + dashboard/AI tool
                  → ship it so teams stop fighting their data.
                </div>
              </div>

              <p style={{ marginTop: "0.9rem" }}>
                I love problems where the data is messy, the process is clunky, and
                someone says, “We don&apos;t really have visibility on this yet.”
              </p>
            </article>
            ...
            <article className="about-text-card" data-reveal>
              ...
              <p>
                ...
                There I worked on projects with companies like PepsiCo, focusing oncd ..
            ...
            <article className="about-text-card" data-reveal>
              <div className="card-title-row">
                <h3>Outside Work</h3>
                <span className="chip chip-glow">Fun</span>
              </div>

              <ul className="about-list">
                <li>National-level basketball background — I love team dynamics.</li>
                <li>Obsessed with sunsets, solo trips, and finding dark spots for stargazing.</li>
                <li>
          ...
          <div className="about-side" data-reveal>
            <div className="about-card about-card-fun about-sticky">
              ...
              <div className="about-meta-block">
                ...
                <p className="about-meta-text">
                  Take a messy spreadsheet or data dump, ask annoying questions, build a
                  clean data model and dashboard/AI tool, then watch everyone stop
                  fighting with their data.
                </p>
              </div>
              ...
              <div className="about-meta-block">
                ...
                <p className="about-meta-text">
                  🎯 Business/Data Analyst &nbsp;·&nbsp; 🎯 AI Product / Applied AI — anywhere
                  I can be the bridge between operations, data, and intelligent systems.
                </p>
              </div>
              ...
              <div className="about-meta-block">
                <p className="about-meta-label">What you get if we work together</p>
                <p className="about-meta-text">
                  Someone who enjoys digging into details, but always brings it back to
                  “What decision does this change?” — with dashboards, experiments, and
                  clear communication to back it up.
                </p>
              </div>
            </div>
          </div>
